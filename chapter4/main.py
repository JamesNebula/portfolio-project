...
def read_players(skip: int = 0, limit: int = 100, minimum_last_changed_date = None, 
...
def read_performances(skip: int = 0, limit: int = 100,
                      minimium_last_changed_date: date = None, db: Session = Depends(get_db)):
    performances = crud.get_performances(db, skip=skip, limit=limit, 
                                         min_last_changed_date=minimium_last_changed_date)
    return performances
...
def read_leagues(skip: int = 0, limit: int = 100, 
                 minimum_last_changed_date: date = None, league_name: str = None,
